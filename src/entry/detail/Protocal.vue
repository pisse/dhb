<template>
    <div id="app" class="protocal">
        <div>
            <div>
                <div style="text-align:center;font-size:1.5rem;font-weight:bold;">用户服务协议</div>
                （本协议由甲、乙双方&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;月&nbsp;&nbsp;日签订于上海市崇明区）
<br>甲方（平台用户）：<br>身份证号码：<br><br>乙方：上海华肖网络科技有限公司<br>
                <br>上海华肖网络科技有限公司在此郑重提示您，本文系您与乙方之间的法律协议，请您认真阅读并理解本协议。本协议在您和乙方之间具有法律约束力。
<br>本协议适用于乙方所运营“华肖科技”平台“{{detail.title}}”。<br>
                <br>第一条&nbsp;&nbsp;甲方认购详情<br>1.1甲方同意按照下列约定认购本项目<br>认购本金金额：<br>预期年化收益率：{{detail.rate | toFixed(2)}}%
<br>锁定期限：{{detail.invest_date}}天<br>锁定期限起始日：<br>锁定期限届满日：<br>1.2还款方式：{{detail.return_type}}。<br>
